<template>
                    ...
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.key === 'operation'">
                            <div class="flex align-items-center">
                                ...
                                @click="()=>{visibleInfo=true;applyId=record.applyId;}">查看详情</a-button>
                            </div>
                        </template>
    ...
    <a-modal
        ...
        style="width:1200px;"
    >
        <ReviewInfo :apply-id="applyId" :level="level" @click-close="()=>{visibleInfo=false;}" @refresh="search"/>
    </a-modal>
</template>
...
import ReviewInfo from '@/views/panel/review/ReviewInfo.vue'
...
export default defineComponent({
    ...
    setup() {
        ...
        function search(): void {
            ...
            proxy.$api.apply.getUnreview(level.value, searchParam)
                .then((response: any) => {
